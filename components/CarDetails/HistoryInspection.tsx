...
const HistoryInspection = () => {
  return (
    <div
      className="flex justify-center bg-[#F5F6F7] py-[2rem] mt-[6rem]"
      id="history"
    >
      <div className="w-[85.1267992%]">
        ...
        <div className="hidden sm:block mt-[2rem]">
        ...
        <div className="sm:hidden">
          <div className="mt-8 mb-8">
            <h2 className="text-[1.5625rem] text-fourthBlack leading-[1.8125rem] font-semibold">
              History
            </h2>
            <p className="font-light leading-fifth text-secondaryBlack mt-[0.5rem]">
              Access details like number of previous owners, reported accidents
              and more in your free AutoCheck® vehicle history report.
            </p>
            <div className="mr-4 flex-1">
